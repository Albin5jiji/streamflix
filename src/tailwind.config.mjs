...
export default {
    ...
    theme: {
        extend: {
            ...
            colors: {
                primary: "#FFFFFF",
                "primary-foreground": "#ae8686ff",
                secondary: "#FF7F50",
                "secondary-foreground": "#7d2929ff",
                background: "#000000",
                foreground: "#FFFFFF",
                destructive: "#DF3131",
                ...
                "gradient-light-blue": "#FF7F50",
                "gradient-medium-blue": "#FF7F50",
                "button-outline": "#000000",
                "lavender-gradient-start": "#CBA6FF",
                gridline: "#E0E0E0",
                "lavender-gradient-end": "#E0B3FF"
            },
        },
    },
    future: {
